...
<template>
  <div>
    <Branches :artist-hover="artistHovered" :dev-hover="developerHovered"/>
    <div class="landing-container">
      ...
      <div class="moonwitch-header">
        moonwitch
      </div>
      <div class="moonwitch-nav">
        <NuxtLink to="artist/">
          <div class="artist" ref="artist"><icon-angle-left class="icon" />the artist</div>
        </NuxtLink>
        <NuxtLink to="dev/">
          <div class="developer" ref="developer">the dev<icon-angle-right class="icon" /></div>
        </NuxtLink>
      </div>
    </div>
  </div>
